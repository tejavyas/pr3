...
notable of which is that **we do not** require you to _download and save_ files from the internet. The servers
...
```
git clone https://github.gatech.edu/gios-spr-26/pr3
```

We encourage you to save your code in a separate repository. You can make one in the **gios-spr-26**
...
You will be provided 50 submissions for part 1 and 50 submissions for part 2. 
...
queue) by which the proxy can communicate its request along with the information
...
**In short:**
**The Proxy owns and is responsible for the data channel (shared memory).**
**The Cache owns and is responsible for the command channel (an IPC mechanism of your choice)**
...
for successful runs. This is the only partial credit we award. If your code
did not work but you can explain why fully in your README file, you can receive 
